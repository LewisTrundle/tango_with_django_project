...
class PageForm(forms.ModelForm):
    ...
    class Meta:
        # Provide an association between the ModelForm and a model
        model = Page
        # Instead of including all the fields we need
        # e.g fields = ('title', 'url', 'views')
        # We will exclude the one field we don't need 'category' - the foreign key
        # This allows fields with NULL values to be present
        exclude = ('category',)
